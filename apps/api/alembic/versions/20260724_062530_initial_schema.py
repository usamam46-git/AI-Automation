...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_workflows_current_version_id", "workflows", "workflow_versions", ["current_version_id"], ["id"], ondelete="SET NULL", use_alter=True
    )
    ...
    op.create_foreign_key(
        "fk_agents_current_version_id", "agents", "agent_versions", ["current_version_id"], ["id"], ondelete="SET NULL", use_alter=True
    )
